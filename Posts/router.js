...
const {editPost,editStatus,editStatusByAdmin}=require('./Controller')
...
router.post('/api/editstatus/',isAuth,editStatus)
router.post('/api/editstatusbyadmin/',isAuth,editStatusByAdmin)
